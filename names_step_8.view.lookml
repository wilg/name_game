- view: names_step_8
  ...
  - dimension: name
    ...
    - label: "Popularity over Time"
      url: /explore/name_game/names_step_8?f[names_step_8.name]={{ filterable_value | url_encode }}&fields=names_step_8.year,names_step_8.popularity_index,names_step_8.female_percentage
